...
基于提取的结构因子，设计项目的分层架构。按需从以下维度选择适用的层：
...
2. **分层架构** — 每层的职责、内容、技术组件、依赖方向
3. **目录骨架** — 带注释的完整目录树
4. **层间数据流** — 2-3 个代表性场景的数据流转描述
5. **包/模块组织约定** — 命名规范、文件组织规则、import/export 约定
6. **扩展预留** — 为未来可能引入的组件预留的目录位置
...
| 文件 | 归属 | 用途 | 加载时机 |
|------|------|------|----------|
| `references/output-template.md` | Skill 独有 | 项目结构文档的精确结构与各节填写规范 | 步骤 5 |
