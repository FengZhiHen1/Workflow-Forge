...
|:---|:---|:---|
| `SKILL_ATTACK_DIMS` | `references/attack-dimensions-by-type.md` | 按问题类型的差异化攻击维度 + 量化致命性阈值 |
| `SKILL_COUNTEREX` | `references/counterexample-framework.md` | 系统化反例构造框架（5类反例） |
| `SKILL_PAPER` | `references/paper-review-checklist.md` | 论文评审视角检查清单 |
| `SKILL_FAQ` | `references/judge-faq.md` | 评委常见问题预判（FAQ） |
