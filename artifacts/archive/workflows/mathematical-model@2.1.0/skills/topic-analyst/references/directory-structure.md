...
| 标识 | 路径（相对 skill 根目录） | 说明 |
|:---|:---|:---|
| `SKILL_CONSTRAINTS` | `references/constraint-taxonomy.md` | 约束类型分类与转化框架（C01-C08） |
| `SKILL_MODELS` | `references/model-genealogy.md` | 按问题类型的模型族谱 |
| `SKILL_TEMPLATES` | `references/output-templates.md` | 各 mission 的详细输出模板 |

## 产物路径对照表

| Mission | 产物文件 | 路径 |
|:---|:---|:---|
| P1a 选题分析 | 单选题分析报告 | `GLOBAL_SHARED/P1a-选题分析.md` |
| P1a-Multi 多选题对比 | 多选题对比报告 | `GLOBAL_SHARED/P1a-多选题对比分析.md` |
| P1a-Multi 各选题独立分析 | 各选题独立报告 | `GLOBAL_SHARED/P1a-选题分析_题X.md` |
| P1b 小问分析 | 单小问分析报告 | `PROBLEM_SHARED/P1b-小问分析_Task[N].md` |
| P1c 小问依赖 | 依赖关系分析报告 | `GLOBAL_SHARED/P1c-小问依赖分析.md` |
